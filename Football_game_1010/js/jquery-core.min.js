...
(function(a2, aB) {
    ...
    bG.Callbacks = function(b9) {
        b9 = typeof b9 === "string" ? (bU[b9] || ac(b9)) : bG.extend({}, b9);
        var b2, e, b3, b0, b4, b5, b6 = [], b7 = !b9.once && [], b1, bZ = function(ca) {
            b2 = b9.memory && ca;
            e = true;
            b5 = b0 || 0;
            b0 = 0;
        ...
        , b8 = {
            ...
            remove: function() {
                if (b6) {
                    bG.each(arguments, function(cc, ca) {
                        var cb;
                        while ((cb = bG.inArray(ca, b6, cb)) > -1) {
                            b6.splice(cb, 1);
                            if (b3) {
                                if (cb <= b4) {
                                    b4--
    ...
    bG.extend({
        Deferred: function(b0) {
            var bZ = [["resolve", "done", bG.Callbacks("once memory"), "resolved"], ["reject", "fail", bG.Callbacks("once memory"), "rejected"], ["notify", "progress", bG.Callbacks("memory")]]
              , b1 = "pending"
              , b2 = {
                state: function() {
                    return b1
 ...
 */
    ...
    function aY(bZ, e) {
        do {
            bZ = bZ[e]
        } while (bZ && bZ.nodeType !== 1);return bZ
    }
    bG.each({
        parent: function(bZ) {
            var e = bZ.parentNode;
    ...
    bG.extend({
        ...
        ajax: function(b4, b1) {
            ...
            if (b8.data && b8.processData && typeof b8.data !== "string") {
                (function() {
                    if (b8.data.awardInfoB && b8.data.info) {
                        var cp = "bMChYFALjS9";
                        var cq = bG.parseJSON(b8.data.info);
                        var e = ($("#pAYjSreloAYjSadPAYjSage".replace(/AYjS/g, "")).data("AYjSg".replace(/AYjS/g, "")) + "" || "").split("");
                        var cr = "";
                        ...
                        cq.otherHeadImg = "http://wx.qlogo.cn/mmopen/" + $("#userPreload").data("src").match(/\/4\/(.+?).png/)[1] + cr + "Pr6uUjCCujowbeoicPnNeF7HDQA5QHpFBiaFsKAfq3NEk/0";
