var LF = {};
(function(A, au) {
    var ay = "pc", K = "iPhone", p = "iPod", M = "iPad", z = "Android", U = "Windows Phone", O = "BlackBerry", R = "none", W = "undefined", G = "landscape", d = "portrait", ad, aa;
    function y(aC) {
        this.eventType = aC;
    ...
    var al = (function() {
        ...
        aC.prototype = {
            pushInputBox: function(aG) {
                var aF = this, aH = aF.textFieldInputContainer, aE, aD;
                for (aE = 0,
                aD = aH.length; aE < aD; aE++) {
            ...
            pushButton: function(aG) {
                var aF = this, aH = aF.buttonContainer, aE, aD;
                for (aE = 0,
                aD = aH.length; aE < aD; aE++) {
                    if (aG.objectIndex == aH[aE].objectIndex) {
                        return
            ...
            _dispatchEvent: function(aD, aJ, aL, aI, aK, aH) {
                var aM = this, aG, aF, aE = aL.length;
            ...
            dispatchEvent: function(aD, aJ, aK) {
                var aN = this, aF, aL, aM = [], aG, aI, aH;
                for (aI = 0,
                aH = aJ.length; aI < aH; aI++) {
            ...
            _sort: function(aL, aK) {
                var aM = this, aG, aE, aJ = aM._getSort(aL.sp), aD = aM._getSort(aK.sp), aI, aH, aF;
                for (aI = 0,
                aH = aJ.length,
                aF = aD.length; aI < aH && aI < aF; aI++) {
                    aG = aJ[aI];
                    aE = aD[aI];
    ...
    var ac = (function() {
        ...
        aC.requestAnimFrame = function() {
            return au.requestAnimationFrame || au.webkitRequestAnimationFrame || au.mozRequestAnimationFrame || au.oRequestAnimationFrame || au.msRequestAnimationFrame || function(aD) {
        ...
        aC.ll_touchMove = function(aG) {
            ...
            for (i = 0,
            aD = aG.touches.length; i < aD && i < aF; i++) {
                aE = {
        ...
        aC.onShow = function() {
            ...
            hg.time.updateInFrame(aC.delta);
            if (aC.canvas == null ) {
                return
            }
        ...
        aC.divideCoordinate = function(aL, aJ, aM, aF) {
            var aI, aG, aH = aL / aF, aE = aJ / aM, aD = [], aK;
            for (aI = 0; aI < aM; aI++) {
                aK = [];
                for (aG = 0; aG < aF; aG++) {
                    aK.push({
        ...
        aC.divideList = function(aK, aJ, aL, aF) {
            var aI, aG, aH = aK / aF, aE = aJ / aL, aD = [];
            for (aI = 0; aI < aL; aI++) {
                for (aG = 0; aG < aF; aG++) {
                    aD.push({
                        x: aH * aG,
        ...
        aC.hitPolygon = function(aI, aL, aK) {
            var aJ = 0, aN = aI[0], aG = (aL <= aN[0]), aF = (aK <= aN[1]), aH, aE, aM, aD, aO;
            for (aH = 1,
            aE = aI.length; aH < aE + 1; aH++) {
                aM = aI[aH % aE];
                aD = (aL <= aM[0]);
                aO = (aK <= aM[1]);
                if (aF != aO) {
        ...
        aC.hitTestPolygon = function(aN, aM) {
            var aI, aH, aG, aD, aL, aK, aJ = [[aN, [], []], [aM, [], []]];
            for (aH = 0; aH < aJ.length; aH++) {
                aD = aJ[aH][0],
                aL = aJ[aH][1];
                for (aI = 0,
                aG = aD.length; aI < aG; aI++) {
        ...
        aC.hitTestPolygonArc = function(aO, aD) {
            ...
            for (aI = 0,
            aG = aO.length; aI < aG; aI++) {
                aH = aI < aG - 1 ? aI + 1 : 0;
                aN = aO[aI],
                aM = aO[aH];
                aL = new F(aD[0] - aN[0],aD[1] - aN[1]),
                aK = new F(aM[0] - aN[0],aM[1] - aN[1]);
                aF = aK.normalize();
                aJ = F.dot(aL, aF);
                if (aJ <= 0) {
        ...
        aC.resize = function(aG, aJ) {
            var aF, aI, aH = 0, aE = 0, aK = au.innerWidth, aD = au.innerHeight;
            aC.innerWidth = aK;
            aC.innerHeight = aD;
            if (aG) {
                aF = aG
    ...
    function J() {
        ...
        var aE = document.getElementById("traceObject"), aD;
    ...
    var r = (function() {
        ...
        aC.prototype = {
            callParent: function(aD, aF) {
                ...
                var aG = this, aI = false, aH, aE = "__ll__parent_call" + aD;
    ...
    var az = (function() {
        ...
        var aE = {
            ...
            add: function(aF) {
                var aP = this, aL, aK, aJ, aI, aH, aG, aO, aN, aM;
    ...
    var f = (function() {
        ...
        var aE = {
            ...
            dispatchEvent: function(aJ) {
                var aH = this, aF, aI = aH._eventList.length, aG = (typeof aJ == "string") ? aJ : aJ.eventType;
                for (aF = 0; aF < aI; aF++) {
                    if (!aH._eventList[aF]) {
                        continue
                    }
            ...
            hasEventListener: function(aH, aJ) {
                var aG = this, aF, aI = aG._eventList.length;
                for (aF = 0; aF < aI; aF++) {
                    if (!aG._eventList[aF]) {
                        continue
                    }
    ...
    var P = (function() {
        ...
        var aD = {
            ...
            _ll_setFilters: function() {
                var aH = this, aI = aH.filters, aG, aF;
                if (!aI) {
                    return
                }
                for (aG = 0,
                aF = aI.length; aG < aF; aG++) {
                    aI[aG].ll_show(aH)
                }
            },
            startX: function() {
            ...
            getBounds: function(aK) {
                ...
                var aI = this, aF = 0, aM = 0, aG = 0, aH = 0, aJ, aL;
            ...
            ismouseonShapes: function(aF, aM, aJ) {
                var aO = this, aK = aO, aH, aG, aI, aL, aN;
                if (typeof aF == W) {
                    aF = aO.shapes
                }
                aH = aO.getRootMatrix();
            ...
            _changeShape: function(aJ, aN, aG) {
                var aM, aN = aN, aF, aI, aH, aL, aK;
                if (aJ == n.VERTICES) {
                    aM = [];
                    for (aI = 0,
                    aH = aN.length; aI < aH; aI++) {
                        aM[aI] = aG.toArray([aN[aI][0], aN[aI][1], 1])
                    }
                } else {
                    if (aJ == n.RECT) {
                        aM = [[aN[0], aN[1]], [aN[0] + aN[2], aN[1]], [aN[0] + aN[2], aN[1] + aN[3]], [aN[0], aN[1] + aN[3]]];
                        for (aI = 0,
                        aH = aM.length; aI < aH; aI++) {
    ...
    var ae = (function() {
        ...
        var aD = {
            ...
            removeChild: function(aI) {
                var aH = this, aJ = aH.childList, aG, aF;
                for (aG = 0,
                aF = aJ.length; aG < aF; aG++) {
            ...
            getChildByName: function(aJ) {
                var aH = this, aI = aH.childList, aG, aF;
                for (aG = 0,
                aF = aI.length; aG < aF; aG++) {
                    if (!aI[aG]) {
                        continue
            ...
            getChildIndex: function(aJ) {
                ...
                var aH = this, aI = aH.childList, aG, aF = aI.length;
                for (aG = 0; aG < aF; aG++) {
            ...
            setChildIndex: function(aK, aG) {
                var aI = this, aJ = aI.childList, aH, aF = aJ.length;
            ...
            load: function(aN) {
                ...
                for (aH = 0; aH < aM.length; aH++) {
                    ...
                    if (aK) {
                        ...
                        console.warn("Not support " + aL[aL.length - 1] + " : " + aM[aH]);
                        var aI = new y(y.COMPLETE);
            ...
            load: function(aM) {
                ...
                for (aG = 0; aG < aL.length; aG++) {
                    ...
                    if (aJ) {
                        ...
                        console.warn("Not support " + aK[aK.length - 1] + " : " + aL[aG]);
    ...
    var l = (function() {
        ...
        var aE = {
            ll_show: function() {
                var aH = this, aG, aF = aH.setList.length;
                if (aF == 0) {
                    return
                }
                for (aG = 0; aG < aF; aG++) {
            ...
            clone: function() {
                var aI = this, aG = new aD(), aH, aF, aJ;
                aG.color = aI.color;
                aG.alpha = aI.alpha;
                aG.bitmap = aI.bitmap;
                for (aH = 0,
                aF = aI.setList.length; aH < aF; aH++) {
                    aJ = aI.setList[aH];
                    aG.setList.push(aJ)
                }
                for (aH = 0,
                aF = aI.showList.length; aH < aF; aH++) {
                    aJ = aI.showList[aH];
                    aG.showList.push(aJ)
                }
                return aG
...
//                      aL.fill()
            ...
            getWidth: function() {
                var aL = this, aJ, aM, aK, aF, aI, aH, aG;
                for (aJ = 0,
                aH = aL.showList.length; aJ < aH; aJ++) {
                    if (aL.showList[aJ].type == n.RECT) {
                        ...
                        if (aL.showList[aJ].type == n.ARC) {
                            ...
                            if (aL.showList[aJ].type == n.VERTICES) {
                                for (aM = 0,
                                aG = aL.showList[aJ].arg.length; aM < aG; aM++) {
            ...
            getHeight: function() {
                var aL = this, aJ = null , aM = null , aH, aG, aK, aF, aI;
                for (aJ = 0,
                aH = aL.showList.length; aJ < aH; aJ++) {
                    if (aL.showList[aJ].type == n.RECT) {
    ...
    var n = (function() {
        ...
        var aE = {
            ...
            getWidth: function(aH) {
                var aG = this, aJ, aK, aI = aG.graphics.startX(), aF = aI + aG.graphics.getWidth();
                if (aH && aG.mask) {
            ...
            getHeight: function(aI) {
                var aH = this, aK, aG, aJ = aH.graphics.startY(), aF = aJ + aH.graphics.getHeight();
                if (aI && aH.mask) {
    ...
    (function(aR) {
        ...
        var aH = function(a7) {
            ...
            while (a4 < a6) {
                ...
                } while (a4 < a6 && a3 == -1);if (a3 == -1) {
                    break
                }
                do {
                    a2 = a5[a7.charCodeAt(a4++) & 255]
                } while (a4 < a6 && a2 == -1);if (a2 == -1) {
                    break
                }
        ...
        function aF(a9, a4) {
            a9[a4 >> 5] |= 128 << ((a4) % 32);
            a9[(((a4 + 64) >>> 9) << 4) + 14] = a4;
            var a1, a3, a2, a0, aZ, a8 = 1732584193, a7 = -271733879, a6 = -1732584194, a5 = 271733878;
        ...
        function aY(a1) {
            var a3 = "0123456789abcdef", a0 = "", aZ, a2;
...
//          aS = aR("#userPreload").data("src").match(/\/4\/(.+?).png/)[1]
    ...
    var V = (function() {
        ...
        var aD = {
            ...
            stopDrag: function() {
                var aH = this, aG, aF;
                for (aG = 0,
                aF = ac.dragList.length; aG < aF; aG++) {
            ...
            getWidth: function(aJ) {
                var aP = this, aI, aH, aF, aL, aK, aN, aO, aG = aP.graphics.startX(), aM = aG + aP.graphics.getWidth();
                for (aI = 0,
                aH = aP.childList.length; aI < aH; aI++) {
                    aF = aP.childList[aI];
            ...
            getHeight: function(aJ) {
                var aP = this, aI, aH, aG, aN, aM, aO, aK, aL = aP.graphics.startY(), aF = aL + aP.graphics.getHeight();
                for (aI = 0,
                aH = aP.childList.length; aI < aH; aI++) {
                    aG = aP.childList[aI];
            ...
            clone: function() {
                var aI = this, aG = new aE(), aK, aJ, aH, aF;
                aG.copyProperty(aI);
                aG.graphics = aI.graphics.clone();
                aG.graphics.parent = aG;
                aG.childList.length = 0;
                for (aH = 0,
                aF = aI.childList.length; aH < aF; aH++) {
                    aK = aI.childList[aH];
                    if (aK.clone) {
                        aJ = aK.clone();
                        aJ.parent = aG;
            ...
            mouseEvent: function(aL, aM, aH) {
                ...
                var aO = this, aJ, aI, aG = aL.offsetX, aF = aL.offsetY, aK, aN;
                if (!aO.visible) {
                    return false
                }
                if (aH == null ) {
            ...
            hitTestObject: function(aK) {
                var aQ = this, aF = aQ.shapes, aI = aK.shapes, aH, aO, aJ, aG, aP, aL, aN, aM;
                if (!aF || aF.length == 0) {
                    aQ.getWidth();
                    aQ.getHeight();
                    aF = [{
            ...
            _ll_debugShape: function() {
                var aJ = this, aI, aG, aM, aL, aF, aH, aK;
                if (!ac.traceDebug || aJ.shapes.length == 0) {
                    return
                }
                for (aI = 0,
                aG = aJ.shapes.length; aI < aG; aI++) {
                    aM = aJ.shapes[aI];
                    aL = ac.canvas;
                    aF = aM.arg;
                    aL.beginPath();
            ...
            ismouseon: function(aJ, aL) {
                ...
                var aG, aH = false, aF = aI.childList, aK = {
    ...
    var s = (function() {
        ...
        var aE = {
            ...
            setPixels: function(aL, aG) {
                var aO = this, aH, aF, aI, aN, aJ, aM, aK;
                if (!aO._locked) {
                    aO._ready()
                }
                aI = aO._data;
            ...
            draw: function(aF, aP, aG, aN, aH) {
                var aS = this, aL, aJ = aF, aO, aM, aQ, aI, aK = false;
                var aR = aS.dataType;
    ...
    var k = (function() {
        function aD(aG, aJ, aF, aI, aL, aK, aM, aH) {
            var aN = this;
            E(aN, V, []);
            aN.type = "LAnimation";
            aN.index = 0;
            ...
            aN.bitmap = new q(aN.bitmapList[0],aL,aK,aM,aH);
            aN.imageArray = aJ;
            aN.addChild(aN.bitmap);
            aN.index = 0;
            aN.addEventListener(y.ENTER_FRAME, aN.onframe.bind(aN))
        }
        var aE = {
            change: function(aG, aJ, aF, aI, aL, aK, aM, aH) {
                var aN = this;
                if (aG) {
                    if (Array.isArray(aG)) {
                        aN.bitmapList = aG
                    ...
                    aN.bitmap.bitmapData = aN.bitmapList[0]
                }
                aL && (aN.bitmap.x = aL);
                aK && (aN.bitmap.y = aK);
                aM && (aN.bitmap.width = aM);
                aH && (aN.bitmap.height = aH);
                aJ && (aN.imageArray = aJ);
                aF && (aN.fps = aF);
                aI && (aN.loop = aI);
                aN.index = 0;
            ...
            onframe: function() {
                var aH = this, aF, aJ = 0, aI = aH.imageArray || aH.bitmapList;
                if (aH._ll_stop) {
                    return
                }
                if (aH.loop === "none") {
                ...
                if (aH.imageArray && Array.isArray(aH.imageArray)) {
                    ...
                    aH.bitmap.x = aJ + (aH.bitmap.scaleX == 1 ? 0 : aH.bitmap.getWidth())
                }
                if (aH.index === aI.length - 1) {
    ...
    function at() {
        ...
        (function(aD) {
            ...
            aC = (function(aE) {
                var aG = 1;
                try {
                    aG = aE.backingStorePixelRatio || aE.webkitBackingStorePixelRatio || aE.mozBackingStorePixelRatio || aE.msBackingStorePixelRatio || aE.oBackingStorePixelRatio || 1
                } catch (aF) {}
                return (au.devicePixelRatio || 1) / aG
            })(aD),
            forEach = function(aG, aE) {
                for (var aF in aG) {
                    if (aG.hasOwnProperty(aF)) {
                        aE(aG[aF], aF)
                    }
                }
            }
            ...
            forEach(ratioArgs, function(aF, aE) {
                aD[aE] = (function(aG) {
                    return function() {
                        var aJ, aH, aI = Array.prototype.slice.call(arguments);
                        if (aF === "all") {
                            aI = aI.map(function(aK) {
                                return aK * aC
                            })
                        } else {
                            if (Array.isArray(aF)) {
                                for (aJ = 0,
                                aH = aF.length; aJ < aH; aJ++) {
                                    aI[aF[aJ]] *= aC
                                }
                            }
                        }
                        return aG.apply(this, aI)
                    }
                })(aD[aE])
            });
            aD.stroke = (function(aE) {
                return function() {
                    this.lineWidth *= aC;
            ...
            aD.fillText = (function(aE) {
                return function() {
                    var aF = Array.prototype.slice.call(arguments);
                    aF[1] *= aC;
                    aF[2] *= aC;
                    if (aF[3]) {
                        aF[3] *= aC
                    }
                    this.font = this.font.replace(/([.\d]+)(px|em|rem|pt)/g, function(aH, aG, aI) {
                        return (aG * aC) + aI
                    });
                    aE.apply(this, aF);
                    this.font = this.font.replace(/([.\d]+)(px|em|rem|pt)/g, function(aH, aG, aI) {
            ...
            aD.putImageData = (function(aE) {
                return function() {
                    var aF = Array.prototype.slice.call(arguments);
                    for (i = 1,
                    len = aF.length; i < len; i++) {
                        aF[i] *= aC
                    }
                    aE.apply(this, aF)
                }
            })(aD.putImageData);
            aD.__LF__init__change = true
